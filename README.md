...
Junior 
Top 155 React Interview Questions  React  155  
Answer
...
## React Hooks: Can you initialize state from a function? Provide and example
Answer
Yes! Consider:
...
## React Hooks: What's wrong with that code?
Problem
Consider:
this.setState({
